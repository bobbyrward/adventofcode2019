...
impl Error for GenericError {
    fn description(&self) -> &str {
        "Generic error of some kind, stuff broke"
    }
...
impl Solution for Day11 {
    fn problem1(&self, input: &str) -> String {
        ...
        paint_the_hull("testing", input, &mut canvas, start);
